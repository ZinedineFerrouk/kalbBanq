...
@WebServlet(name = "CustomerTransactionServlet", value = "/customer/transfer")
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (responseCode != 200L){
                ...
                this.getServletContext().getRequestDispatcher("/customer-transfer.jsp").forward(request, response);
                return;
            }
