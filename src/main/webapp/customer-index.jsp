...
<div class="blue">
    <div class="d-flex p-5 justify-content-center flex-raw">
        ...
        <div class="w-25 bg-light shadow-sm p-3">
            <h6 class="mb-3">Nous enrichir sur votre dos</h6>
            <p class="fw-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium amet architecto
                at commodi cum delectus dolore illum
                iure molestiae, nam neque non, numquam officia possimus recusandae similique soluta ut, vel.</p>
        </div>
