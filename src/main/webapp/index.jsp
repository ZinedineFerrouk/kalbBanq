    ...
    <div class="cards-background-container d-flex justify-content-center align-items-center">
        <div class="bg-transparent container">
            <div class="d-flex justify-content-center align-items-center">
                <img class="n26-card-red" src="public/assets/images/n26-cards-mastercard-rhubarb-fr.webp">
                <img class="n26-card-black" src="public/assets/images/n26-cards-mastercard-metal-charcoalblack.webp">
                <img class="n26-card-transparent" src="public/assets/images/n26-cards-mastercard-fr.webp">
            </div>
